...
import { Layout, Button, Badge, Typography, List, Space, Popconfirm, message, ConfigProvider, theme, App } from 'antd';
import {
  PauseCircleOutlined,
  PlayCircleOutlined,
  PoweroffOutlined,
...
function QueueItem({ song, onRemove, onMoveUp, onMoveDown, index, isFirst, isLast }: QueueItemProps) {
  return (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  <button
                      ...
                      style={{
                        background: 'none',
                        border: 'none',
                        color: isFirst ? 'rgba(255,255,255,0.2)' : 'rgba(255,255,255,0.45)',
                  ...
                  <MenuOutlined style={{ color: 'rgba(255, 255, 255, 0.45)', fontSize: 14 }} />
                  <button
                      ...
                      style={{
                        background: 'none',
                        border: 'none',
                        color: isLast ? 'rgba(255,255,255,0.2)' : 'rgba(255,255,255,0.45)',
...
export default function ActiveSession() {
  ...
  if (showVoting) {
    return <VotingPhase onVotingComplete={handleVotingComplete} />;
  }
                  ...
                  {mockLyrics.map((line, index) => {
                    ...
                    return (
                        <div
                            ...
                            //   color: isActive ? '#FF2D7E' : 'rgba(255,255,255,0.65)',
